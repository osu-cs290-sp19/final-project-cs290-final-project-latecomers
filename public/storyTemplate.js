...
templates['story'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"content-box story-box\">\r\n                    <p class=\"story-title\">"
    ...
    + "</p>\r\n                    <ul>\r\n                        <li class=\"story-tag\">"
    + alias4(((helper = (helper = helpers.storyTags || (depth0 != null ? depth0.storyTags : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"storyTags","hash":{},"data":data}) : helper)))
    + "</li>\r\n                     \r\n                    </ul>\r\n                </div>";
},"useData":true});
})();