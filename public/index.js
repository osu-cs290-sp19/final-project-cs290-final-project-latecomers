...
function createStory(storyText, storyAuthor)
{
    ...
    var theObject = _constructStoryObject(0,'create',0,storyText, storyAuthor, 0, 0);
...
function _constructStoryObject(storyId, storyOperation, storyUpvotes, storyText, storyAuthor, storyImage, storyEnd)
{
    var storyObject = {
